...
public class TeaKettle extends CustomProjectileEntityOld {
    ...
    public TeaKettle(Level pLevel, Player pPlayer, Vec3 pPos, Vec3 targetPos) {
        super(ModEntities.TEA_KETTLE.get(), pLevel);
    ...
    protected void onHitEntity(Entity entity, Vec3 hitVec, Vec3 startVec, Vec3 endVec)
    {
        ...
        if (entity != this.owner && this.tickCount > 2) {
            ...
            if (!this.level().isClientSide) {
                ...
                serverLevel.playSound(null, this.getOnPos(), ModSounds.KETTLE_BREAKING.get(), SoundSource.PLAYERS, 1.5F, 1F);
            }
        }
    }
