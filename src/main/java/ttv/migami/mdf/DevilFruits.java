...
import ttv.migami.mdf.entity.ai.FruitAI;
import ttv.migami.mdf.entity.ai.fruit.skeleton.SkeletonFruitAI;
...
import ttv.migami.mdf.entity.client.spider.*;
...
import ttv.migami.mdf.event.CapabilityEventHandler;
...
public class DevilFruits {
    ...
    public DevilFruits() {
        ...
        ModCapabilities.register(new RegisterCapabilitiesEvent());
