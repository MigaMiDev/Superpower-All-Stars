...
public class ModContainers {
    ...
    public static final RegistryObject<MenuType<MoveSelectionMenu>> MOVE_SELECTION = register("move_selection", MoveSelectionMenu::new);
    public static final RegistryObject<MenuType<PermanentFruitsMenu>> PERMANENT_FRUITS = register("permanent_fruits", PermanentFruitsMenu::new);
