...
public class MoveSelectionMenu extends AbstractContainerMenu {
    private final MobEffect currentFruit;

    public MoveSelectionMenu(int windowId, Inventory playerInventory) {
        super(ModContainers.MOVE_SELECTION.get(), windowId);
