...
import ttv.migami.spas.entity.fruit.spider.FireSpiderString;

@OnlyIn(Dist.CLIENT)
public class SpiderStringFireRenderer extends EntityRenderer<FireSpiderString> {
   private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Reference.MOD_ID, "textures/fruit/spider/spider_string_fire.png");
   private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

   public SpiderStringFireRenderer(EntityRendererProvider.Context pContext) {
      super(pContext);
   }

   protected int getBlockLightLevel(FireSpiderString pEntity, BlockPos pPos) {
      return 15;
   }

   public void render(FireSpiderString pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
      pPoseStack.pushPose();
    ...
    */
   public ResourceLocation getTextureLocation(FireSpiderString pEntity) {
