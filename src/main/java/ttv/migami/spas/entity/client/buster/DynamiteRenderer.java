package ttv.migami.spas.entity.client.buster;
...
import ttv.migami.spas.entity.fruit.buster.Dynamite;

@OnlyIn(Dist.CLIENT)
public class DynamiteRenderer extends EntityRenderer<Dynamite> {
   private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Reference.MOD_ID, "textures/fruit/buster/dynamite.png");
   ...
   protected int getBlockLightLevel(Dynamite pEntity, BlockPos pPos) {
      return 7;
   }

   public void render(Dynamite pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
      pPoseStack.pushPose();
