...
import ttv.migami.spas.entity.fruit.spider.Croissant;

@OnlyIn(Dist.CLIENT)
public class CroissantRenderer extends EntityRenderer<Croissant> {
   private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Reference.MOD_ID, "textures/fruit/spider/croissant.png");
   private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

   public CroissantRenderer(EntityRendererProvider.Context pContext) {
      super(pContext);
   }

   protected int getBlockLightLevel(Croissant pEntity, BlockPos pPos) {
      return 15;
   }

   public void render(Croissant pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
      pPoseStack.pushPose();
    ...
    */
   public ResourceLocation getTextureLocation(Croissant pEntity) {
