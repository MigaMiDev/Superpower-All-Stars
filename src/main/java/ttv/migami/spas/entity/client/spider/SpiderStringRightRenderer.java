...
import ttv.migami.spas.entity.fruit.spider.RightSpiderString;

@OnlyIn(Dist.CLIENT)
public class SpiderStringRightRenderer extends EntityRenderer<RightSpiderString> {
   private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Reference.MOD_ID, "textures/fruit/spider/spider_string_2.png");
   private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

   public SpiderStringRightRenderer(EntityRendererProvider.Context pContext) {
      super(pContext);
   }

   protected int getBlockLightLevel(RightSpiderString pEntity, BlockPos pPos) {
      return 15;
   }

   public void render(RightSpiderString pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
      pPoseStack.pushPose();
    ...
    */
   public ResourceLocation getTextureLocation(RightSpiderString pEntity) {
