...
import ttv.migami.spas.entity.fruit.spider.TeaKettle;

@OnlyIn(Dist.CLIENT)
public class TeaKettleRenderer extends EntityRenderer<TeaKettle> {
   private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Reference.MOD_ID, "textures/fruit/spider/tea_kettle.png");
   private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

   public TeaKettleRenderer(EntityRendererProvider.Context pContext) {
      super(pContext);
   }

   protected int getBlockLightLevel(TeaKettle pEntity, BlockPos pPos) {
      return 15;
   }

   public void render(TeaKettle pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
      pPoseStack.pushPose();
    ...
    */
   public ResourceLocation getTextureLocation(TeaKettle pEntity) {
