package ttv.migami.spas.entity;
 ...
 * Author: MrCrayfish
 */
public abstract class CustomThrowableEntity extends ThrowableProjectile implements IEntityAdditionalSpawnData
{
    ...
    public CustomThrowableEntity(EntityType<? extends CustomThrowableEntity> entityType, Level worldIn)
    {
        super(entityType, worldIn);
    }

    public CustomThrowableEntity(EntityType<? extends CustomThrowableEntity> entityType, Level world, LivingEntity player)
    {
        super(entityType, player, world);
    }

    public CustomThrowableEntity(EntityType<? extends CustomThrowableEntity> entityType, Level world, double x, double y, double z)
    {
