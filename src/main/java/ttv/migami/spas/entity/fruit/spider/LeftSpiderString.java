...
public class LeftSpiderString extends CustomProjectileEntity {
    ...
    public LeftSpiderString(EntityType<?> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public LeftSpiderString(Level pLevel, Player pPlayer, Vec3 pPos, Vec3 targetPos, float damage) {
        super(ModEntities.LEFT_SPIDER_STRING.get(), pLevel);
