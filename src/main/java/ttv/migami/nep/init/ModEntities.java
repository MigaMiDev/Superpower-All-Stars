...
import ttv.migami.nep.entity.fruit.StunEntity;
import ttv.migami.nep.entity.fruit.buster.*;
import ttv.migami.nep.entity.fruit.fire.Fireball;
import ttv.migami.nep.entity.fruit.fire.LargeFireball;
import ttv.migami.nep.entity.fruit.flower.*;
import ttv.migami.nep.entity.fruit.skeleton.Bone;
...
import ttv.migami.nep.entity.fruit.squid.InkSplat;
import ttv.migami.nep.entity.fx.CracksMarkEntity;
import ttv.migami.nep.entity.fx.InkMarkEntity;
import ttv.migami.nep.entity.fx.LargeInkMarkEntity;
import ttv.migami.nep.entity.fx.ScorchMarkEntity;
...
public class ModEntities
{
    ...
    public static final RegistryObject<EntityType<CracksMarkEntity>> CRACKS_MARK = REGISTER.register("cracks_mark", () -> EntityType.Builder.<CracksMarkEntity>of(CracksMarkEntity::new, MobCategory.MISC).sized(11.0F, 1.0F).noSave().noSummon().build("cracks_mark"));
}
