...
public class CracksMarkRenderer extends EntityRenderer<CracksMarkEntity> {
   private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Reference.MOD_ID, "textures/ground/ground_cracks.png");
   private static final RenderType RENDER_TYPE = RenderType.entityTranslucent(TEXTURE_LOCATION);

   public CracksMarkRenderer(EntityRendererProvider.Context pContext) {
      super(pContext);
   }

   protected int getBlockLightLevel(CracksMarkEntity pEntity, BlockPos pPos) {
      return 15;
   }

   public void render(CracksMarkEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
      pPoseStack.pushPose();
    ...
    */
   public ResourceLocation getTextureLocation(CracksMarkEntity pEntity) {
