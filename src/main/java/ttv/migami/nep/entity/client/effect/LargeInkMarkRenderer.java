...
public class LargeInkMarkRenderer extends EntityRenderer<LargeInkMarkEntity> {
   private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Reference.MOD_ID, "textures/ground/large_ink_splat.png");
   private static final RenderType RENDER_TYPE = RenderType.entityTranslucent(TEXTURE_LOCATION);

   public LargeInkMarkRenderer(EntityRendererProvider.Context pContext) {
      super(pContext);
   }

   protected int getBlockLightLevel(LargeInkMarkEntity pEntity, BlockPos pPos) {
      return 15;
   }

   public void render(LargeInkMarkEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
      pPoseStack.pushPose();
    ...
    */
   public ResourceLocation getTextureLocation(LargeInkMarkEntity pEntity) {
