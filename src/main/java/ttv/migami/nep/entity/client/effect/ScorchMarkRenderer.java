...
public class ScorchMarkRenderer extends EntityRenderer<ScorchMarkEntity> {
   private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Reference.MOD_ID, "textures/ground/scorch_mark.png");
   private static final RenderType RENDER_TYPE = RenderType.entityTranslucent(TEXTURE_LOCATION);

   public ScorchMarkRenderer(EntityRendererProvider.Context pContext) {
      super(pContext);
   }

   protected int getBlockLightLevel(ScorchMarkEntity pEntity, BlockPos pPos) {
      return 15;
   }

   public void render(ScorchMarkEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
      pPoseStack.pushPose();
    ...
    */
   public ResourceLocation getTextureLocation(ScorchMarkEntity pEntity) {
