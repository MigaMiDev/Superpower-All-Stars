package ttv.migami.nep.entity.client.fire;
...
@OnlyIn(Dist.CLIENT)
public class LargeFireballRenderer extends EntityRenderer<LargeFireball> {
   private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Reference.MOD_ID, "textures/fruit/fire/fireball.png");
   private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

   public LargeFireballRenderer(EntityRendererProvider.Context pContext) {
      super(pContext);
   }

   protected int getBlockLightLevel(LargeFireball pEntity, BlockPos pPos) {
      return 15;
   }

   public void render(LargeFireball pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
      pPoseStack.pushPose();
    ...
    */
   public ResourceLocation getTextureLocation(LargeFireball pEntity) {
