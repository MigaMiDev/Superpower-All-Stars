...
import ttv.migami.nep.client.ClientHandler;
import ttv.migami.nep.client.KeyBinds;
import ttv.migami.nep.client.MetaLoader;
import ttv.migami.nep.datagen.FruitGen;
import ttv.migami.nep.entity.ai.FruitAI;
import ttv.migami.nep.entity.ai.fruit.skeleton.SkeletonFruitAI;
import ttv.migami.nep.entity.client.StunEntityRenderer;
import ttv.migami.nep.entity.client.buster.CactusGeoRenderer;
import ttv.migami.nep.entity.client.buster.CustomLassoRenderer;
import ttv.migami.nep.entity.client.buster.DynamiteRenderer;
import ttv.migami.nep.entity.client.buster.PianoRenderer;
import ttv.migami.nep.entity.client.effect.CracksMarkRenderer;
import ttv.migami.nep.entity.client.effect.InkMarkRenderer;
import ttv.migami.nep.entity.client.effect.LargeInkMarkRenderer;
import ttv.migami.nep.entity.client.effect.ScorchMarkRenderer;
import ttv.migami.nep.entity.client.fire.FireballRenderer;
import ttv.migami.nep.entity.client.fire.LargeFireballRenderer;
import ttv.migami.nep.entity.client.flower.*;
import ttv.migami.nep.entity.client.skeleton.BoneZoneGeoRenderer;
import ttv.migami.nep.entity.client.skeleton.GasterBlasterGeoRenderer;
import ttv.migami.nep.entity.client.skeleton.SmallBoneRenderer;
import ttv.migami.nep.entity.client.spider.*;
import ttv.migami.nep.entity.client.squid.InkSplatRenderer;
import ttv.migami.nep.init.*;
import ttv.migami.nep.network.PacketHandler;
import ttv.migami.nep.network.persistent.ModNetworking;
import ttv.migami.nep.world.loot.ModLootModifiers;

import java.util.concurrent.CompletableFuture;

@Mod(Reference.MOD_ID)
public class NotEnoughPowers {
    public static boolean debugging = false;
    public static final Logger LOGGER = LogManager.getLogger(Reference.MOD_ID);
    public static boolean jegLoaded = false;

    public NotEnoughPowers() {
